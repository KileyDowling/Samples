...
namespace MovieCatalog.UI.Models
{
    public class MovieEditVM
    {
        ...
        public void CreateGenreList(List<Genre> genres)
        {
            ...
            {
                Genres.Add(new SelectListItem() {Text = g.GenreName, Value = g.GenreID.ToString()});
            }   
        }

        public void CreateActorsNotInMovie(List<Actor> actors)
        {
